...
#define SEG_UCODE1   	3           // User code1
#define SEG_UDATA1   	4           // User data/stack1
#define SEG_UCODE2		5			// User code2
#define SEG_UDATA2		6			// User data/stack2
#define SEG_TSS     	7           // Global unique task state segement
#define SEG_KDISPLAY 	8			// Kernel display segement
...
#define MAX_FP_NUM	8
#define MAX_SYS_FILE_NUM 	512

enum p_state{RUNNABLE, RUNNING, BLOCKED, SEM_BLOCKED, DEAD};
...
sysFile sysFileTable[MAX_SYS_FILE_NUM];
int sys_file_num;
